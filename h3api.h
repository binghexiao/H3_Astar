...
typedef struct {
    ...
    GeoPoint verts[MAX_CELL_BNDRY_VERTS];  ///< vertices in ccw order
} CellBoundary;
...
/** @defgroup pointToCell pointToCell
 * Functions for pointToCell
 * @{
 */
/** @brief find the H3 index of the resolution res cell containing the lat/lng
 */
DECLSPEC H3Error H3_EXPORT(pointToCell)(const GeoPoint *g, int res,
                                        H3Index *out);
/** @} */

/** @defgroup cellToPoint cellToPoint
 * Functions for cellToPoint
 * @{
 */
/** @brief find the lat/lon center point g of the cell h3 */
DECLSPEC H3Error H3_EXPORT(cellToPoint)(H3Index h3, GeoPoint *g);
/** @} */
...
DECLSPEC int H3_EXPORT(gridDiskUnsafe)(H3Index origin, int k, H3Index *out);
/** @} */

/** @brief hexagons neighbors in all directions, assuming no pentagons,
 * reporting distance from origin */
DECLSPEC int H3_EXPORT(gridDiskDistancesUnsafe)(H3Index origin, int k,
                                                H3Index *out, int *distances);

/** @brief hexagons neighbors in all directions reporting distance from origin
 */
DECLSPEC void H3_EXPORT(gridDiskDistancesSafe)(H3Index origin, int k,
                                               H3Index *out, int *distances);

/** @brief collection of hex rings sorted by ring for all given hexagons */
DECLSPEC int H3_EXPORT(gridDisksUnsafe)(H3Index *h3Set, int length, int k,
                                        H3Index *out);

/** @brief hexagon neighbors in all directions */
DECLSPEC void H3_EXPORT(gridDisk)(H3Index origin, int k, H3Index *out);
/** @} */
 ...
 */
DECLSPEC void H3_EXPORT(gridDiskDistances)(H3Index origin, int k, H3Index *out,
                                           int *distances);
/** @} */
...
DECLSPEC int H3_EXPORT(gridRingUnsafe)(H3Index origin, int k, H3Index *out);
/** @} */
...
DECLSPEC int H3_EXPORT(maxPolygonToCellsSize)(const GeoPolygon *geoPolygon,
                                              int res);

/** @brief hexagons within the given geopolygon */
DECLSPEC void H3_EXPORT(polygonToCells)(const GeoPolygon *geoPolygon, int res,
                                        H3Index *out);
/** @} */
 ...
 * @{
 */
/** @brief "great circle distance" between pairs of GeoPoint points in radians*/
double H3_EXPORT(pointDistRads)(const GeoPoint *a, const GeoPoint *b);

/** @brief "great circle distance" between pairs of GeoPoint points in
 * kilometers*/
double H3_EXPORT(pointDistKm)(const GeoPoint *a, const GeoPoint *b);

/** @brief "great circle distance" between pairs of GeoPoint points in meters*/
...
DECLSPEC int64_t H3_EXPORT(uncompactCellsSize)(const H3Index *compactedSet,
...
DECLSPEC int H3_EXPORT(uncompactCells)(const H3Index *compactedSet,
                                       const int64_t numCompacted,
                                       H3Index *outSet, const int64_t numOut,
                                       const int res);
/** @} */
 ...
 * destination */
DECLSPEC H3Index H3_EXPORT(cellsToDirectedEdge)(H3Index origin,
                                                H3Index destination);
/** @} */
 ...
 * H3Index */
DECLSPEC H3Index H3_EXPORT(getDirectedEdgeOrigin)(H3Index edge);
/** @} */
 ...
 * H3Index */
DECLSPEC H3Index H3_EXPORT(getDirectedEdgeDestination)(H3Index edge);
/** @} */
 ...
 * edge H3Index */
DECLSPEC void H3_EXPORT(directedEdgeToCells)(H3Index edge,
 ...
 */
DECLSPEC void H3_EXPORT(originToDirectedEdges)(H3Index origin, H3Index *edges);
/** @} */
...
DECLSPEC void H3_EXPORT(directedEdgeToBoundary)(H3Index edge, CellBoundary *gb);
/** @} */
 ...
 */
/** @brief Returns a single vertex for a given cell, as an H3 index */
DECLSPEC void H3_EXPORT(vertexToPoint)(H3Index vertex, GeoPoint *point);
/** @} */
